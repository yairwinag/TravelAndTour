    ...
    <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-end justify-content-center">
            <div class="col-md-9 ftco-animate pb-5 text-center">
                ...
                <p class="breadcrumbs"><span class="mr-2"><a href="{{ route('userHome.index') }}">Home <i
                                class="ion-ios-arrow-forward"></i></a></span> <span>Sign in</span></p>
            </div>
        </div>
    </div>
</section>
            ...
            <form action="{{ route('signIn.index')}}?package_id={{$id ?? ''}}" id="" method="post">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <center>
                            <button type="submit" name="" class="btn btn-warning" data-dismiss="modal"
                                id="sign-text">OK</button>
                        </center>
                    </div>
                </div>
            </form>
